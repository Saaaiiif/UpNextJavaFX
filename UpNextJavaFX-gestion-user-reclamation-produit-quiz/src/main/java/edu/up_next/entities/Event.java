...
public class Event {
    ...
    public Event(int id, int host_id, String title, String descrip, LocalDateTime startdate, LocalDateTime enddate, String status_event, Integer ticket_count, int guest_id, String location,String image , double ticket_price) {
        this.id = id;
