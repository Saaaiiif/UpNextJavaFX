...
public class SceneTransitionUtil {
    ...
    public static <T> T changeContent(String fxmlPath, TransitionType transitionType, Class<T> controller) throws IOException {
        ...
        if (loader.getController() instanceof CommunitiesController) {
            ((CommunitiesController) loader.getController()).setThemeMode(isDarkMode);
        } else if (loader.getController() instanceof CommunityDetailController) {
            ((CommunityDetailController) loader.getController()).setThemeMode(isDarkMode);
        } else if (loader.getController() instanceof UserCommunitiesController) {
            ((UserCommunitiesController) loader.getController()).setThemeMode(isDarkMode);
        }
                    ...
                    try {
                        ...
                        dataTask.setOnSucceeded(dataEvent -> {
                            ...
                            Platform.runLater(() -> {
                                ...
                                // Set the theme mode for controllers that support it
                                if (controllerInstance instanceof CommunitiesController) {
                                    ((CommunitiesController) controllerInstance).setThemeMode(isDarkMode);
                                } else if (controllerInstance instanceof CommunityDetailController) {
                                    ((CommunityDetailController) controllerInstance).setThemeMode(isDarkMode);
                                } else if (controllerInstance instanceof UserCommunitiesController) {
                                    ((UserCommunitiesController) controllerInstance).setThemeMode(isDarkMode);
                                }
