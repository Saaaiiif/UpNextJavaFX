...
public class MainPage extends Application {
    ...
    private void showSessionSelectionDialog() throws IOException {
        ...
        // Set the application icon for the dialog
        Image dialogIcon = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/logo.png")));
        ...
        // Pass the current theme preference from SessionManager
