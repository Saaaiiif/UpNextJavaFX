...
public class home {
    ...
    void goToProfile(ActionEvent event) {
        try {
            ...
            // 🧠 ➔ Sauvegarde la scène actuelle AVANT de changer
            NavigationManager.push(((Node) event.getSource()).getScene());
    ...
    public void ajout_event(MouseEvent event) {
        try {
    ...
    public void list_event_home(MouseEvent event) {
        try {
            NavigationManager.push(((Node) event.getSource()).getScene());
